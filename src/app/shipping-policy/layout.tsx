...
export const metadata: Metadata = {
  title: 'Shipping Policy - BellaPassi | Your Data Protection and Privacy',
  description: 'Read BellaPassi\'s Shipping Policy to understand how we protect your personal information, data security measures, and your privacy rights when shopping with us.',
  keywords: [
    'Shipping policy', 'BellaPassi privacy', 'data protection', 'user privacy', 
  ...
  robots: 'index, follow',
  openGraph: {
    title: 'Shipping Policy - BellaPassi',
