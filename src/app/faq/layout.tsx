...
export const metadata: Metadata = {
  title: 'Faq - BellaPassi | Your Data Protection and Privacy',
  description: 'Read BellaPassi\'s Faq to understand how we protect your personal information, data security measures, and your privacy rights when shopping with us.',
  keywords: [
    'Faq', 'BellaPassi privacy', 'data protection', 'user privacy', 
