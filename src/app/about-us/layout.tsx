...
export const metadata: Metadata = {
  title: 'About Us - BellaPassi | Your Data Protection and Privacy',
  description: 'Read BellaPassi\'s About Us to understand how we protect your personal information, data security measures, and your privacy rights when shopping with us.',
  keywords: [
    'About Us', 'BellaPassi privacy', 'data protection', 'user privacy', 
