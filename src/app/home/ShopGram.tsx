        ...
        <section className="section mt-4" data-aos="fade-up">
            <div className="container">
                ...
                <div className="shop-gram-products">
                    <div className="row">
                        {/* ✅ Check shopgrams exists and has items before mapping */}
                        {shopgrams && Array.isArray(shopgrams) && shopgrams.length > 0 ? (
                            ...
                            // Fallback UI when no shopgrams
                            <div className="col-12 text-center py-5">
                                <p>No shopgrams available</p>
                            </div>
                        )}
                    </div>
                </div>
