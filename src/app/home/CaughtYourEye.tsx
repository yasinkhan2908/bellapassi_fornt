...
export const CaughtYourEye = ({ title, subtitle, products }: ProductSectionProps) => {
  return (
                      ...
                      <div className="w-28 w-52">
                        <div className="cursor-pointer group">
                          <div className="overflow-hidden relative ripple">
                            <Link href="#" data-track="#" data-track-position="upcoming-drop-menu" data-page="Home" data-link-position="1" prefetch={false}>
                              <Image width={40} height={40} src={item.image} loading="lazy" alt="" className="lazy-img-fadein w-100" />
                            </Link>
