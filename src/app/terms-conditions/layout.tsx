...
export const metadata: Metadata = {
  title: 'Terms & Condition - BellaPassi | Your Data Protection and Privacy',
  description: 'Read BellaPassi\'s Terms & Condition to understand how we protect your personal information, data security measures, and your privacy rights when shopping with us.',
  keywords: [
    'Terms & Condition', 'BellaPassi privacy', 'data protection', 'user privacy', 
  ...
  robots: 'index, follow',
  openGraph: {
    title: 'Terms & Condition - BellaPassi',
