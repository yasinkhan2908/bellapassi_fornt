...
export const metadata: Metadata = {
  title: 'Privacy Policy - BellaPassi | Your Data Protection and Privacy',
  description: 'Read BellaPassi\'s Privacy Policy to understand how we protect your personal information, data security measures, and your privacy rights when shopping with us.',
  keywords: [
    'privacy policy', 'BellaPassi privacy', 'data protection', 'user privacy', 
  ...
  robots: 'index, follow',
  openGraph: {
    title: 'Privacy Policy - BellaPassi',
